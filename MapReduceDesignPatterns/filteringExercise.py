...
# The dataset is more complicated and closer to what you might
...
# we use the csv module of Python. Each 'line'
...
def mapper():
    ...
    for line in reader:
        ...
        body_split = re.split('[.!?]', body)
        
        if len(body_split) == 1 or (len(body_split) == 2 and body_split[1] == ""): 
